...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": f"s3://{bucket_name}/{output_paths['customer_trusted']}",
        "partitionKeys": [],
    },
    format="parquet",
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": f"s3://{bucket_name}/{output_paths['accelerometer_trusted']}",
        "partitionKeys": [],
    },
    format="parquet",
    format_options={"compression": "snappy"},
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": f"s3://{bucket_name}/{output_paths['customer_curated']}",
        "partitionKeys": [],
    },
    format="parquet",
    format_options={"compression": "snappy"},
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": f"s3://{bucket_name}/{output_paths['step_trainer_trusted']}",
        "partitionKeys": [],
    },
    format="parquet",
    format_options={"compression": "snappy"},
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": f"s3://{bucket_name}/{output_paths['machine_learning_curated']}",
        "partitionKeys": [],
    },
    format="parquet",
    format_options={"compression": "snappy"},
